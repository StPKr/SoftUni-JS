...
export default function About() {
    return (
        <section id="about-section">
            ...
            <div id="about-team">
                <h2 className='about-h2'>Meet Our Founders</h2>
                ...
                <div className="team-member">
                    ...
                    <h3>Jane Smith</h3>
                    <p>Main Event Coordinator. Jane ensures our meetings are organized and engaging.</p>
                </div>
            </div>
