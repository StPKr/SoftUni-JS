    ...
    <div class="row space-top">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="material" value=${item.material}>
            </div>
...
export async function showEditView(ctx) {
    ...
    const item = await dataServices.getFurnitureDetails(id);
...
async function onSubmit(e) {
    ...
    await dataServices.updateFurniture(id, item);
    context.goTo('/')
